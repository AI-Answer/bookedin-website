...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <meta name="google-site-verification" content="g5D5kq-GtDMIdG8HaGV3Pl7KVf5VYrOksRIsw2Hw-YE" />
      ...
      >
        ...
        {/* Wistia Player Script - still prioritized, but no longer blocking initial paint */}
        <Script
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        {/* Google Analytics */}
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-3D4MMHNWCL" strategy="lazyOnload" />
